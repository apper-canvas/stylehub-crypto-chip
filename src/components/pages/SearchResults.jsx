...
const SearchResults = () => {
  ...
  const applyFiltersAndSort = () => {
    ...
    // Apply filters (same logic as CategoryBrowse)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                {query ? `Showing results for "${query}"` : "All products"} - {filteredProducts.length} {filteredProducts.length === 1 ? 'product' : 'products'} found
              </p>
            </div>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <ProductGrid
              ...
              emptyDescription="Try different keywords or browse our categories"
            />
          </div>
        </div>
      </div>
